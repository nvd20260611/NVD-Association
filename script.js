...
const translations = {
  zh: {
    ...
    indexPageTitle: "NVD 協會｜移動主權、生活韌性與公共資料倡議",
    indexPageDescription:
      "NVD 協會是以移動主權、生活韌性與公共資料倡議為核心的公共行動平台，關注無障礙空間、照顧支持、社區安全、教育推廣與行動專案。",
    ...
    heroKicker: "NVD 協會｜公共行動平台",
    heroTitle: "讓每一種移動，都能被看見",
    heroSubtitle: "<strong>NVD 協會關注的不只是道路</strong>，而是每個人在生活中能不能安全、自由、有尊嚴地移動與參與社會。從道路障礙回報、無障礙空間倡議，到照顧支持、社區韌性與公共資料整理，我們把日常生活中被忽略的困難，轉化成可以被理解、被討論、被改善的行動。",
    homeIdeaTitle: "讓每一種移動，都能被看見",
    homeIdeaLead:
      "NVD 不是單一路平平台，而是推動移動主權、生活韌性與公共資料倡議的公共行動平台。",
    homeProjectEyebrow: "目前主力行動",
    homeReportTitle: "路平與無障礙回報行動",
    homeReportLead:
      "這是 NVD 目前第一個示範專案。我們用照片、定位與資料整理，讓道路障礙不只是個人抱怨，而是可以被追蹤、被討論、被改善的公共資料。",
    homeProjectCta: "查看 ROAD HUB",
    searchLabel: "搜尋道路行動、理念或參與方式",
    searchPlaceholder: "搜尋道路行動、理念或參與方式...",
    statsProcessedFiles: "友善行動節點",
    reportStatusValue: "公共行動平台",
    reportStatusLabel: "移動主權｜生活韌性｜公共資料倡議",
    ...
    homePrimaryCta: "加入 NVD 行動",
    homeSecondaryCta: "查看行動專案",
    homeTertiaryCta: "了解 NVD",
    ...
    homeFlowTitle: "我們如何行動",
    homeFlowLead: "從生活經驗出發，讓需求被整理、被串聯、被回應。",
    homeFlowCollect: "蒐集需求",
    homeFlowOrganize: "整理資料",
    homeFlowConnect: "串聯資源",
    homeFlowImprove: "推動改善",
    homeAudienceTitle: "誰適合加入",
    homeAudienceLead: "不同角色都能用自己的經驗、專業或場域參與 NVD。",
    ...
    homePartnerTitle: "合作入口",
    homePartnerLead:
      "NVD 歡迎企業、政府、學校、社區與社福單位，一起把生活經驗轉化為公共行動。",
  ...
  en: {
    ...
    indexPageTitle: "NVD Association｜Mobility Autonomy, Living Resilience, and Public Data Advocacy",
    indexPageDescription:
      "NVD is a public-action platform centered on mobility autonomy, living resilience, and public data advocacy, with work across accessible spaces, care support, community safety, education, and action projects.",
    ...
    heroKicker: "NVD Association｜Public Action Platform",
    heroTitle: "Making every kind of mobility visible",
    heroSubtitle: "<strong>NVD looks beyond roads alone</strong>. We care whether people can move through daily life and participate in society safely, freely, and with dignity. From road-barrier reports and accessible-space advocacy to care support, community resilience, and public data organizing, we turn overlooked everyday difficulties into action that can be understood, discussed, and improved.",
    homeIdeaTitle: "Making every kind of mobility visible",
    homeIdeaLead:
      "NVD is not a single road-repair platform. It is a public-action platform for mobility autonomy, living resilience, and public data advocacy.",
    homeProjectEyebrow: "Current main action",
    homeReportTitle: "Road access and accessibility reporting action",
    homeReportLead:
      "This is NVD's first demonstration project. Through photos, location notes, and organized information, road barriers become public data that can be tracked, discussed, and improved rather than staying as individual complaints.",
    ...
    reportStatusValue: "Public action platform",
    reportStatusLabel: "mobility autonomy | living resilience | public data advocacy",
    ...
    homePrimaryCta: "Join NVD Action",
    homeSecondaryCta: "View Action Projects",
    homeTertiaryCta: "About NVD",
    aboutEyebrow: "About NVD",
    ...
    homeFlowTitle: "How We Act",
    homeFlowLead:
      "Starting from lived experience, NVD helps needs be organized, connected, and responded to.",
    homeFlowCollect: "Collect Needs",
    homeFlowOrganize: "Organize Data",
    homeFlowConnect: "Connect Resources",
    homeFlowImprove: "Support Improvement",
    homeAudienceTitle: "Who Can Join",
    homeAudienceLead:
      "Different roles can take part through lived experience, professional skills, or local settings.",
    ...
    homePartnerTitle: "Partnership Entry Points",
    homePartnerLead:
      "NVD welcomes businesses, government, schools, communities, and social welfare groups to turn lived experience into public action.",
...
const brandVoiceContent = {
  plain: {
    zh: {
      ...
      heroTitle: "讓每一種移動，都能被看見",
      heroSubtitle:
        "<strong>NVD 關心的不只是道路</strong>，而是每個人能不能安全、自由、有尊嚴地移動與參與社會。我們把日常被忽略的困難整理成公共資料，讓更多人一起理解與改善。",
      homePrimaryCta: "加入 NVD 行動",
      homeSecondaryCta: "查看行動專案",
      homeTertiaryCta: "了解 NVD",
  ...
  official: {
    zh: {
      ...
      navCommunity: "關於 NVD",
      heroKicker: "NVD 協會｜公共行動平台",
      heroTitle: "以移動主權、生活韌性與公共資料倡議推動社會參與",
      heroSubtitle:
        "<strong>NVD 協會不以單一道路議題自我限制</strong>，而是從無障礙空間、照顧支持、社區安全、教育推廣與公共資料整理出發，將生活中被忽略的困難轉化為可理解、可討論、可改善的公共行動。",
      homePrimaryCta: "加入 NVD 行動",
      homeSecondaryCta: "查看行動專案",
      homeTertiaryCta: "了解 NVD",
