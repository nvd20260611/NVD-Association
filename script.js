...
const translations = {
  zh: {
    ...
    homeFlowVerify: "再次驗證",
    homeAudienceTitle: "NVD 可以協助",
    homeAudienceLead: "NVD 連結身障同儕、公共部門、企業與教育組織，讓真實需求被整理成可合作、可溝通、可持續改善的方向。",
    helpPeersTitle: "身障同儕",
    helpPeersText: "NVD 協助身障同儕更友善地使用 AI 工具與輔具，改善表達、移動、互動、學習、工作與生活品質。",
    helpGovernmentTitle: "政府單位",
    helpGovernmentText: "NVD 協助政府更理解身障者與行動不便者的真實生活需求，將同儕經驗整理為公共倡議、政策溝通與服務改善的參考。",
    helpBusinessTitle: "企業與輔具廠商",
    helpBusinessText: "NVD 協助企業與輔具廠商取得更貼近生活現場的使用回饋，讓產品、服務與工具設計更符合身障同儕與高齡化社會的需求。",
    helpEducationTitle: "教育單位與社會組織",
    helpEducationText: "NVD 協助教育單位與社會組織推動 AI 工具學習、輔具使用、表達訓練、職能發展、同儕支持與公共倡議相關合作。",
